    ...
    <div class="container min-vh-100 d-flex align-items-center justify-content-center">
        <div class="w-90">
            <div class="bg-white rounded-4 shadow p-4">
                <img src="https://cdn.cellphones.com.vn/media/logo/smember.png" alt="Logo" class="d-block mx-auto mb-3" style="max-width:120px;">
                ...
                <form class="register-form" action="${pageContext.request.contextPath}/register" method="post">
                    <div class="d-flex justify-content-between mb-3 gap-2">
                        <a href="${pageContext.request.contextPath}/login-google" class="btn btn-outline-secondary flex-fill">
                            <i class="fab fa-google"></i> Google
                        </a>
                        <a href="<%= fbLoginUrl %>" class="btn btn-primary flex-fill" style="background:#1877f2; border:none;">
